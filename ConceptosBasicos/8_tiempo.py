...
velocidad = 15
direccion = True
posX0, posY0 = randint(40, 400), randint(40, 300)
posX1, posY1 = randint(40, 400), randint(40, 300)
lado = 40
...
while True:
    ...
    # Mostrar texto
    ventana.blit(texto, (20, 30))
    # tiempo
    tiempo = 'Tiempo: ' + str(pygame.time.get_ticks() / 1000) # Segundo
    texto = fuente.render(tiempo, False, colorTexto)
